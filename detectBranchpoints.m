...
%
% There are 16 candidates that represent all of the "T" or "Y" branchpoints
% in a 3x3 matrix. This code uses a lookup table to detect them in
% skeletonized binary images. NOTE: to view these patterns, execute the
% following:
% A = [1 3 7;1 3 9;1 7 9;3 7 9;2 4 6;2 4 8;2 6 8;4 6 8;1 6 8;3 4 8;2 6 7;
%     2 4 9;1 3 8;1 6 7;3 4 9;2 7 9];
% tiledlayout(4,4)
% for ii = 1:size(A, 1)
%     nexttile
%     m = false(3);
...
% 08/06/2020
%
% 11/14/20: Modified to use a 16-pattern lut instead of a 12-pattern one.
%    Also added display of the LUT patterns as an executable comment above.
%
